...
const Page = () => {
  ...
  const createSmartAccount = async (signer) => {
    ...
    const smartAccount = await createSmartAccountClient({
      signer: signer,
      bundlerUrl:
        "https://bundler.biconomy.io/api/v2/2442/nJPK7B3ru.dd7f7861-190d-41bd-af80-6877f74b8f44",
      biconomyPaymasterApiKey: "G3DiEcOaZ.f454da31-ace3-4258-a384-a8d1035f8dd3",
